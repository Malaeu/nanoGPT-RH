...
Generated: 2025-12-27T02:03:11.079211
...
- **R_t** = Var(s[t-40:t]) / 0.178 (on actual spacing values)
...
| Check | Status | Value |
|-------|--------|-------|
| Mean spacing ≈ 1.0 | ✓ PASS | 1.0003 |
| Min spacing > 0 | ✓ PASS | 0.1016 |
| No NaN/Inf | ✓ PASS | clean |

- S mean: 1.0003 (target: 1.0)
- S std: 0.4058 (target: ~0.42)
- R mean: 0.9301 (target: ~1.0)

## 4. CI Test Results

| Test | X | Y | Z | HSIC | p-value | Independent? |
|------|---|---|---|------|---------|--------------|
| R_t ⊥ S_deep | R_t | S_deep | S_{t-1}, Z_t | 0.000148 | 0.1450 | ✓ Yes |
| Y_t ⊥ Z_t | Y_t | Z_t | ∅ | 0.018499 | 0.0000 | ✗ No |
